...
export default function RatesModal({ rates, onClose, onSave }) {
  ...
  function handleSave() {
    onSave({
      gasPricePerTherm: Math.max(0, Number(gasPricePerTherm) || 0),
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: "1.5rem" }}>
          ...
          {[
            { label: "Gas price ($/therm)", value: gasPricePerTherm, onChange: setGasPricePerTherm, step: "0.01", min: "0" },
            { label: "Electricity price ($/kWh)", value: elecPricePerKwh, onChange: setElecPricePerKwh, step: "0.01", min: "0" },
